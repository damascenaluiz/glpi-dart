/// Representation in enumerated types for GLPI classes.
///These types are required for some API methods.
/// See in: https://forge.glpi-project.org/apidoc/class-CommonDBTM.html
enum ItemType {
  APIClient,
  Alert,
  AuthLDAP,
...
/// Extension to get String value of ItemType.
extension ItemTypeMethods on ItemType {
  /// Returns a String representation of the ItemType value.
